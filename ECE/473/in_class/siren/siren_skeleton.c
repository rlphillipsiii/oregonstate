...
// 10.31.2013
// 
// Setup TCNT1 to be a varaible frequency tone generator. Its made variable
// by dynamically changing the compare register.
//
// Setup TCNT3 to interrupt the processor at a rate of 1000 times 
...
//
// set OC1A (PB5) is the audio output signal
// PORTB (PB7) is the PWM signal for creating the volume control
//
