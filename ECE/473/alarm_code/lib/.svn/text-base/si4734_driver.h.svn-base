...
#define MUTE_LR 0x0003
#define MUTE_L  0x0001
#define MUTE_R  0x0002
#define UNMUTE  0x0000
...
void    sw_pwr_up();
void    radio_pwr_dwn();
void    set_property(uint16_t property, uint16_t value, uint8_t wait);

void enable_radio();
void reset_radio();
void get_signal_strength(char signal[10]);
